...
import VariantItems from '@/components/ProductsPage/Form/Steps/Variant/Complimentary/ComplimentaryItemGroup/VariantItems/VariantItems'
import useComplimentaryItemGroup from '@/components/ProductsPage/Form/Steps/Variant/Complimentary/ComplimentaryItemGroup/useComplimentaryItemGroup'
...
const ComplimentaryItemGroup: FC<ComplimentaryItemGroupProps> = (props) => {
  ...
  const { form, complimentaryIdx, variantIdx } = props
    ...
    <div className="lg:col-span-2 flex flex-col gap-8">
      <div className="w-full flex justify-between items-center gap-4">
        <div className="flex flex-col gap-1">
          ...
          {form.formState.errors?.variants?.[variantIdx]?.complimentary?.[
            complimentaryIdx
          ]?.items && (
                ...
                <div key={field.id} className="w-full flex flex-col gap-4">
                  <div className="w-full flex gap-x-6 gap-y-10">
                    <div className="w-full">
                      <CustomSelect
                        name={`variants.${variantIdx}.complimentary.${complimentaryIdx}.items.${idx}.product_id`}
                  ...
                  <div className="pl-4 pr-12">
                    <VariantItems
                      ...
                      productId={
                        form.watch(
                          `variants.${variantIdx}.complimentary.${complimentaryIdx}.items.${idx}.product_id`
                        ) as string
                      }
                      form={form}
                    />
