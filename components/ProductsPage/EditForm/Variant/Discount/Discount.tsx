...
import useDiscount from '@/components/ProductsPage/EditForm/Variant/Discount/useDiscount'
      ...
      {!fields.length ? (
        ...
        fields.map((field, idx) => (
          ...
          >
            ...
            <div>
              <CustomSelect
                name={`discount.${idx}.payment_type`}
                control={form.control}
                label={'Payment Type'}
