...
import useComplimentary from '@/components/ProductsPage/EditForm/Variant/Complimentary/useComplimentary'
...
import ComplimentaryItemGroup from '@/components/ProductsPage/EditForm/Variant/Complimentary/ComplimentaryItemGroup/ComplimentaryItemGroup'
...
const Complimentary: FC<ComplimentaryProps> = (props) => {
  const { isComplimentary, fields, handleAddRow, remove } =
    useComplimentary(props)
  const { form, productDetails, productVariantDetails } = props
          ...
          >
            ...
            <div>
              <CustomNumberFormatInput
                ...
                control={form.control}
                label={`Quantity (${productDetails?.unit})`}
