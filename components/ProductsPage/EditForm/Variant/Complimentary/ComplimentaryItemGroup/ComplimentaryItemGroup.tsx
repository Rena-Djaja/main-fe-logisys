...
import useComplimentaryItemGroup from '@/components/ProductsPage/EditForm/Variant/Complimentary/ComplimentaryItemGroup/useComplimentaryItemGroup'
import VariantItems from '@/components/ProductsPage/EditForm/Variant/Complimentary/ComplimentaryItemGroup/VariantItems/VariantItems'
...
const ComplimentaryItemGroup: FC<ComplimentaryItemGroupProps> = (props) => {
  const { fields, complimentaryList, isValidating, remove, handleAddRow } =
    useComplimentaryItemGroup(props)
  const { productVariantDetails, form, complimentaryIdx } = props
