...
import useTrucks from '@/components/InventoryPage/Tabs/Trucks/useTrucks'
  ...
  return (
    <div className="mt-8 w-full flex flex-col gap-10">
      <div className="w-full flex flex-col">
        <h1 className="font-semibold text-[2rem]">Truck List</h1>
        <span className="font-medium text-[0.95rem]">
          Manage all the trucks listed below
        </span>
      </div>
        ...
        <div className="w-full flex justify-between">
          <div className="w-full flex gap-2 font-semibold text-[1.25rem]">
            ...
            <span className="opacity-70">
              {truckList?.pagination.total_data}
            </span>
          </div>
